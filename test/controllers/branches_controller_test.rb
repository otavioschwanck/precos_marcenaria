...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { city_id: @branch.city_id, name: @branch.name, phone: @branch.phone, user_id: @branch.user_id }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { city_id: @branch.city_id, name: @branch.name, phone: @branch.phone, user_id: @branch.user_id }
    assert_redirected_to branch_path(assigns(:branch))
  end
